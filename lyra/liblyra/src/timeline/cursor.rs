...
type InnerStream = Pin<Box<dyn Stream<Item = Result<Event, LyraError>> + Send>>;
...
impl EventStream {
    ...
    fn pick_conn(pool: &ConnPool, segment: &Segment) -> Result<Conn, LyraError> {
...
impl Stream for EventStream {
    type Item = Result<Event, LyraError>;
